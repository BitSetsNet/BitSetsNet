...
namespace BitsetsNET
{
    public class ArrayContainer : Container
    {
        ...
        {
            int newCapacity = (this.content.Length == 0) ? DEFAULT_INIT_SIZE : this.content.Length * 2;
            if (newCapacity < min) newCapacity = min * 2;
        ...
        public override Container difference(BitsetContainer x)
        {
        ...
        public override Container difference(ArrayContainer value2)
        {
            ArrayContainer value1 = this;
            int desiredCapacity = value1.getCardinality();
            ArrayContainer answer = new ArrayContainer(desiredCapacity);
            answer.cardinality = Utility.unsignedDifference2by2(value1.content,
                                                               value1.getCardinality(), value2.content,
                                                               value2.getCardinality(), answer.content);
            return answer;
        }
        ...
        {
            ArrayContainer value1 = this;
            bool answer = Utility.unsignedOverlaps2by2(this.content, this.getCardinality(), 
                                                              x.content, x.getCardinality());
            return answer;
        }
